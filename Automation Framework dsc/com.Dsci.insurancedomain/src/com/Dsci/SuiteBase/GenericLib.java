...
log.info("waiting for :" + element.toString() + " for :" +
...
public boolean waitForElementNotPresent(WebElement element, long
timeOutInSeconds) {
...
private  Wait<WebDriver> getfluentWait(int timeOutInSeconds, int
...
public  WebElement waitForElementFluentWait(WebElement element, int
timeOutInSeconds, int pollingEveryInMiliSec){
...
public WebElement getElementById(WebDriver driver,String elementid) {

WebElement elementwithid = driver.findElement(By.id(elementid));

return elementwithid;

}

public  WebElement getElementByXpath(WebDriver driver,String elementxpath) {

WebElement elementwithxpath=  driver.findElement(By.xpath(elementxpath));
return elementwithxpath;

}

   public  WebElement getElementByCssSelector(WebDriver driver,String elementcss) {
    WebElement elwithcss= driver.findElement(By.xpath(elementcss));
    return elwithcss;
